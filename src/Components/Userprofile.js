...
const Userprofile = () => {
    ...
    return (
        <div>
            <Sidebar />
            <div className="card cards-outer">
                <div className="card-body">
                    <div className="d-flex flex-column align-items-center text-center">
                        ...
                        <div className="mt-3">
                            ...
                            <button className="btn btn-light m-right">Follow</button>
                    ...
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <span className="text-white">https://codervent.com</span>
                        </li>
                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 className="mb-0">
                                <svg
                            ...
                            <span className="text-white">codervent</span>
                        </li>
                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 className="mb-0">
                                <svg
